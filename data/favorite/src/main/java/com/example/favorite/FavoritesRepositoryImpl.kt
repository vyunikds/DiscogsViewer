...
class FavoritesRepositoryImpl
    ...
    constructor(
        ...
        override fun consumeReleaseIds(): Flow<List<String>> = localDataSource.consumeReleaseIds()

        override fun consumeCount(): Flow<Int> = localDataSource.consumeCount()

        override fun consumeFavoriteGenres(): Flow<List<String>> = localDataSource.consumeFavoriteGenres()

        override suspend fun getFilteredGenreCount(genre: String): Int = localDataSource.getFilteredGenreCount(genre)
